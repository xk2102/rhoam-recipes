  ...
  if (user) {
    return (
      <div className={styles.createARecipe}>
        ...
        {step === 2 && <Step2 step={step} setStep={setStep} recipe={recipe} setRecipe={setRecipe} />}
        {step === 3 && <Step3 step={step} setStep={setStep} recipe={recipe} setRecipe={setRecipe} />}
        {step === 5 && <Step5 step={step} setStep={setStep} recipe={recipe} setRecipe={setRecipe} />}
      </div>
    );
  } else {
    return (
