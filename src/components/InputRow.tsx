...
export const InputRow: React.FC<{
  ...
  return (
    <div className={styles.inputRow}>
      ...
      {valueError && valueError === "ok" && <BsFillCircleFill className={styles.checkIcon} color="#80aa61" />}
      {valueError && valueError !== "" && valueError !== "ok" && <BsFillCircleFill className={styles.checkIcon} color="#ff6c64" />}
    </div>
  );
};
